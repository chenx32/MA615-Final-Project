pacman::p_load(shinydashboard,shiny,leaflet,htmltools,tidyverse,httr,ggmap,jsonlite,tidyr,dplyr,kableExtra,ggplot2,MASS,plotly,ggmap,car,psych,leaflet,htmltools,tidytext,wordcloud,wordcloud2,reshape2,kableExtra,devtools)
        ...
        tabItem(tabName = "Seperate2",
                fluidRow(
                    box(selectInput("stores3","Choose a store:",
                                    choices=c(unique(as.character(yelp_review$name))))),
